...
//	{VCLK_SD},
    ...
    {ENCI_SYNC_VSO_EVNLN,        0x0508 },
    {ENCI_SYNC_VSO_ODDLN,        0x0508 },
    ...
    {VFIFO2VD_LINE_TOP_START,    17 },
    {VFIFO2VD_LINE_TOP_END,      17+240 },
    {VFIFO2VD_LINE_BOT_START,    18 },
    {VFIFO2VD_LINE_BOT_END,      18+240 },
    {VFIFO2VD_CTL,              0x4e01, },
    {ENCI_DBG_PX_RST,            0,     },
    {VENC_INTCTRL,               0x2,   },
    {VENC_VDAC_SETTING,          0,     },
...
//	{VCLK_SD},
    ...
    {ENCP_VIDEO_VSO_END,         0x5,   },
    {ENCP_VIDEO_VSO_BLINE,       0,     },  //added by JZD. Switch Panel to 576p first time, movie video flicks if not set this to 0
    {ENCP_VIDEO_SY_VAL,          8,     },
    {ENCP_VIDEO_SY2_VAL,         0x1d8, },
    {VENC_SYNC_ROUTE,            0,     },
    {VENC_INTCTRL,               0x200, },
